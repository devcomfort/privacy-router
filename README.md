...
Only External Model tokens incur provider charges. The total depends on the external-route ratio, prompt and response length, and the configured OpenRouter price. See [`docs/user/cost.md`](docs/user/cost.md) for the calculation.
...
Model and prompt evaluation reports are archived under `docs/experiments/`; this product overview does not generalize those experiment-specific results.
...
| [`docs/experiments/README.md`](docs/experiments/README.md) | Model evaluation reports index |
