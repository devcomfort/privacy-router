...
Raw trial payloads are stored in `var/evaluations/legacy-runner`, outside published documentation and Git tracking.
"""
...
RESULTS_DIR = ROOT.parent / "var" / "evaluations" / "legacy-runner"
