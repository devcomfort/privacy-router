...
- [Architecture — pipeline and components](../dev/architecture.md) — how detection fits in the pipeline
- [Data flow — ExtractionRecord and sensitivity](../dev/data-flow.md) — data types produced by detection
- [Masking and hydration](masking-hydration.md) — what happens after detection
- [Ground truth test data](../experiments/ground-truth.json) — 17 evaluation cases
