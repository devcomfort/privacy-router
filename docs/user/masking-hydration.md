...
- [Detection](detection.md) — how sensitive data is detected before masking
- [Data flow — MaskingContract](../dev/data-flow.md) — data types and masking result structure
- [Storage — encryption](../dev/storage.md) — persisted fields and retention behavior
- [Security](security.md) — threat model, trust boundaries, and residual risk
