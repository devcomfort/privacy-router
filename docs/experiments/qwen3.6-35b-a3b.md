...
Gemma4 대비 **메모리 약 절반(23.8 vs 49.3 GiB)**, **KV 캐시 2배(132k vs 66k tok)**, **decode 소폭 우위(60.4 vs 48.4 tok/s)**. 다만 탐지 정확도가 낮다(기준 MTP2 15/19 vs Gemma4 18/19) — 안전 쿼리 오탐과 기관명·맥락 스팬 누락이 많아 decision 모델 교체는 추가 검증이 필요합니다.
